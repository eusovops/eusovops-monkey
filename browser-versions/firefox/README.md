...
Maimuta is a custom userscript manager built for Firefox with Manifest V2 compliance. It supports all standard Greasemonkey/ViolentMonkey/TamperMonkey userscripts.
