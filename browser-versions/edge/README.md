...
Maimuta is a custom userscript manager built for Edge with full Manifest V3 compliance. It supports all standard Greasemonkey/ViolentMonkey/TamperMonkey userscripts.
